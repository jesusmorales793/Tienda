...
public class CarritoController {
    ...
    //Para ver el carrito   VER TODOS LOS ITEMS QUE ESTAN EN LOS CARRITOS 
    ...
    //Para Agregar un producto al carrito  ||parecido al metd Eliminar o MOdificar que hemos hecho antes
